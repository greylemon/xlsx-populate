...
**Kind**: instance method of [<code>Cell</code>](#Cell)  
**Returns**: [<code>Cell</code>](#Cell) - the cell.  
<a name="Cell+sharedFormula"></a>

#### cell.sharedFormula() ⇒ <code>string</code>
Gets the translated shared formula.Based on the approach from [https://github.com/dtjohnson/xlsx-populate/issues/129](https://github.com/dtjohnson/xlsx-populate/issues/129) but more efficient.

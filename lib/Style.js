...
const nodeOrder = ['alignment', 'protection'];
...
class Style {
    ...
    _set_horizontalAlignment(alignment) {
        xmlq.setChildAttributes(this._xfNode, 'alignment', { horizontal: alignment }, nodeOrder);
    ...
    _set_justifyLastLine(justifyLastLine) {
        xmlq.setChildAttributes(this._xfNode, 'alignment', { justifyLastLine: justifyLastLine ? 1 : null }, nodeOrder);
        xmlq.removeChildIfEmpty(this._xfNode, 'alignment');
    }
    ...
    _set_indent(indent) {
        xmlq.setChildAttributes(this._xfNode, 'alignment', { indent }, nodeOrder);
        xmlq.removeChildIfEmpty(this._xfNode, 'alignment');
    }
    ...
    _set_verticalAlignment(alignment) {
        xmlq.setChildAttributes(this._xfNode, 'alignment', { vertical: alignment }, nodeOrder);
        xmlq.removeChildIfEmpty(this._xfNode, 'alignment');
    }
    ...
    _set_wrapText(wrapText) {
        xmlq.setChildAttributes(this._xfNode, 'alignment', { wrapText: wrapText ? 1 : null }, nodeOrder);
        xmlq.removeChildIfEmpty(this._xfNode, 'alignment');
    }
    ...
    _set_shrinkToFit(shrinkToFit) {
        xmlq.setChildAttributes(this._xfNode, 'alignment', { shrinkToFit: shrinkToFit ? 1 : null }, nodeOrder);
        xmlq.removeChildIfEmpty(this._xfNode, 'alignment');
    }
    ...
    _set_textDirection(textDirection) {
        ...
        xmlq.setChildAttributes(this._xfNode, 'alignment', { readingOrder }, nodeOrder);
        xmlq.removeChildIfEmpty(this._xfNode, 'alignment');
    }
    ...
    _setTextRotation(textRotation) {
        xmlq.setChildAttributes(this._xfNode, 'alignment', { textRotation }, nodeOrder);
        xmlq.removeChildIfEmpty(this._xfNode, 'alignment');
    }

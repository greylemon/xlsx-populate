...
class Column {
     ...
     */
    hidden() {
        return new ArgHandler("Column.hidden", arguments)
            .case(() => {
    ...
    /**
     * Get the Attribute Id for a Column
     * @returns {AttributeId}
     */
    getAttributeId() {
	 ...
	 */
    style() {
        return new ArgHandler("Column.style", arguments)
            .case('string', name => {
                // Get single value
            ...
            .case('Style', async style => {
                ...
                this._style = style;
                this._node.attributes.style = await style.id();
     ...
     */
    width(width) {
        return new ArgHandler("Column.width", arguments)
            .case(() => {
                return this._node.attributes.width;
            })
            .case('number', width => {
    ...
    toXml() {
        if (!this._style && this._node.attributes.s != null){
            this._node.attributes.style = this._sheet._workbook._styleSheet.getRowColNewStyleId(this._node.attributes.s);
        }
        return this._node;
    }

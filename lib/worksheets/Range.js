...
class Range {
     ...
     */
    formula() {
        return new ArgHandler("Range.formula", arguments)
            .case(() => {
     ...
     */
    merged(merged) {
        return new ArgHandler('Range.merged', arguments)
            .case(() => {
     ...
     */
    dataValidation() {
        return new ArgHandler('Range.dataValidation', arguments)
            .case(() => {
	 ...
	 */
    style() {
        return new ArgHandler("Range.style", arguments)
            .case('string', name => {
                // Get single value
     ...
     */
    value() {
        return new ArgHandler("Range.value", arguments)
            .case(() => {
                // Get values

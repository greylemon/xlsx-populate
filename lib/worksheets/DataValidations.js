...
class DataValidations {
    ...
    setDataValidation(address, dataValidation) {
        if (dataValidation.type === 'any') return this.delete(address);
        ...
        const isX14 = formula1.replace(/"[^"]*"/g, '').indexOf('!') > 0
        ...
        if (dataValidation.type === 'list' || dataValidation.type === 'custom') delete node.attributes.operator;

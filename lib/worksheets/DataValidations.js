...
class DataValidations {
    ...
    getDataValidation(address, parseFormula = true) {
        ...
        const hasFormula1 = isX14 ? node.children[0].attributes.name === 'x14:formula1' : node.children.length > 0;
        const hasFormula2 = isX14 ? node.children[0].attributes.name === 'x14:formula2' : node.children.length > 1;
        if (hasFormula1) {

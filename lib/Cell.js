...
class Cell {
     ...
     */
    setValue(value) {
        // TODO: remove references from reference table
        if (this._formulaType) this.clear();
        this._modified = true;
        this._value = value;

        // do calculations on other cells
        ...
        calculations.forEach(cal => {
            ...
            cell._value = cell.evaluateFormula();
        });
    ...
    setFormula(formula) {
        ...
        if (result !== this._value) this.setValue(result);
    }
